...
set FOLDER video_edge
set FILENAME vvd_video_edge
set DesignName hls_video_edge
...
# Connect DMA_IN
connect_bd_intf_net [get_bd_intf_pins axi_dma_in_0/M_AXIS_MM2S] [get_bd_intf_pins image_filter_0/INPUT_STREAM]
startgroup
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {Auto} Clk_slave {Auto} Clk_xbar {Auto} Master {/processing_system7_0/M_AXI_GP0} Slave {/image_filter_0/s_axi_CONTROL_BUS} ddr_seg {Auto} intc_ip {New AXI Interconnect} master_apm {0}}  [get_bd_intf_pins image_filter_0/s_axi_CONTROL_BUS]
...
# Connect DMA_OUT
connect_bd_intf_net [get_bd_intf_pins image_filter_0/OUTPUT_STREAM] [get_bd_intf_pins axi_dma_out_0/S_AXIS_S2MM]
startgroup
